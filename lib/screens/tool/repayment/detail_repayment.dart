...
class DetailRepaymentScreen extends StatefulWidget {
  const DetailRepaymentScreen({Key? key}) : super(key: key);

  @override
  _DetailRepaymentScreenState createState() => _DetailRepaymentScreenState();
}

class _DetailRepaymentScreenState extends State<DetailRepaymentScreen>

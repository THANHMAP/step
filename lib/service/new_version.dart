...
class NewVersion {
  ...
  Future<VersionStatus?> getFirebaseVersion(String versionFirebaseConfig) async {
    ...
    return VersionStatus._(
      ...
      storeVersion:
      _getCleanVersion(versionFirebaseConfig),
      appStoreLink: Platform.isIOS ? "https://apps.apple.com/app/co-opsmart/id1617291811?uo=4" : "https://play.google.com/store/apps/details?id=com.step.bank.step_bank",
      releaseNotes: "",
    );
  }
